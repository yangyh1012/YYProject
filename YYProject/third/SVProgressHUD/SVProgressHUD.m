...
- (void)updateMask {
    ...
    switch (self.defaultMaskType) {
        ...
        case SVProgressHUDMaskTypeBlack:{
            ...
            //黑色模式下的背景颜色
            self.backgroundLayer.backgroundColor = self.defaultMaskType == SVProgressHUDMaskTypeCustom ? self.backgroundLayerColor.CGColor : [UIColor colorWithWhite:0 alpha:0.1].CGColor;
...
- (void)positionHUD:(NSNotification*)notification {
    ...
    newCenter = CGPointMake(CGRectGetWidth(self.frame) / 2.0, CGRectGetHeight(self.frame) / 2.0);
